...
class TestWorkflow {
    ...
    fun runWorkflowChained(): TestResult {
        return runTest(timeout = 5.minutes) {
            ...
            ballots.forEach { ballot ->
                val state =
                    if (count % (nballots / 3) == 0) EncryptedBallot.BallotState.SPOILED else EncryptedBallot.BallotState.CAST
    ...
    @Test
    fun runWorkflowAllAvailableJson(): TestResult {
        ...
        return runTest(timeout = 5.minutes) {
            ...
            // encrypt
            batchEncryption(
                group, inputDir = workingDir, ballotDir = ballotsDir, device = "runWorkflowAllAvailableJson",
            ...
            runDecryptTally(
                ...
                workingDir,
                workingDir,
                readDecryptingTrustees(group, trusteeDir, init, present, true),
    ...
    @Test
    fun runWorkflowChainedJson(): TestResult {
    ...
    @Test
    fun runWorkflowSomeAvailableJson(): TestResult {
        ...
        return runTest(timeout = 5.minutes) {
            ...
            // encrypt
            batchEncryption(
                group, inputDir = workingDir, ballotDir = ballotsDir, device = "runWorkflowSomeAvailableJson",
                outputDir = workingDir, null, invalidDir = invalidDir, nthreads, "createdBy"
            )
