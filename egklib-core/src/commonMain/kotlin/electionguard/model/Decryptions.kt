...
data class SelectionDecryptionResult(
...
class TrusteeDecryptions(val trusteeId : String) {
    val shares = mutableMapOf<String, SelectionDecryptionResult>() // key "contestId#@selectionId" aka "selectionKey"
    ...
    fun addDecryption(contestId: String, selectionId: String, ciphertext: ElGamalCiphertext, decryption: PartialDecryption) {
        ...
        this.shares[selectionKey] = SelectionDecryptionResult(selectionKey, ciphertext, decryption)
    }
